    ...
    <main className="max-w-4xl mx-auto px-4 py-16 space-y-24 text-[var(--color-darker)] dark:text-[var(--color-lighter)]">
      ...
      <MotionWrapper className="space-y-4">
        ...
        <p>
          ...
          in web development. I specialize in building full stack applications
          using React, Node.js, and PostgreSQL, and I&apos;m always striving to
          improve my skills and learn new technologies. With every project, I
          aim to solve real problems, experiment with modern tools, or create
          something that challenges my thinking.
          <br />
          <br />
          I&apos;m currently open to summer internships, freelance work, or
          collaborative dev projects. If you&apos;re looking for a motivated,
      ...
      <MotionWrapper className="space-y-4">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            <strong>Projects</strong> – A quick way to see what I can do and
            what I&apos;m comfortable with.
          </li>
          <li>
            <strong>Resume</strong> – A web version of my resume with a
            downloadable PDF link in the footer.
          </li>
          <li>
            <strong>Blog</strong> – Monthly updates on what I&apos;m working on
            and learning.
          </li>
          <li>
            <strong>Feedback</strong> – Drop feedback through the contact form
            in the footer.
          </li>
        </ul>
      </MotionWrapper>
