      ...
      <MotionWrapper className="space-y-4 border-l-4 pl-4 border-[var(--color-primary)]">
        ...
        {[
          ...
          },
          {
            ...
            icons: ['react.svg', 'nextjs.svg', 'tailwind.svg'],
          },
          {
            label: 'Backend',
            items: ['Node.js', 'Firebase'],
            icons: ['nodejs.svg', 'firebase.svg'],
          },
          {
            label: 'Databases',
            items: ['PostgreSQL'],
          ...
          {[
            {
              ...
              description:
                'Built a personal portfolio with Next.js and Tailwind CSS...',
              link: 'https://github.com/cbpcbphillips/portfolio',
            },
            {
              title: 'LeetCode Solutions Repository',
              description:
                'Documented solutions to LeetCode problems using C++...',
