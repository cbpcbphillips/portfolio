...
export default function Footer() {
  ...
  return (
    <footer className="mt-12 border-t border-[var(--color-lighter)] dark:border-[var(--color-darker)] px-4 py-8 text-[var(--color-lighter)] dark:text-[var(--color-darker)] bg-[var(--color-darker)] dark:bg-[var(--color-lighter)]">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
        {/* Left Column */}
        <div>
          <h4 className="font-bold mb-2">Contact</h4>
          <p>
            Phone Number: <a className="underline">(936)-404-3346</a>
          </p>
          <p>
            Email:{' '}
