    ...
    <footer className="mt-12 border-t border-[var(--color-lighter)] dark:border-[var(--color-darker)] px-4 py-10 text-[var(--color-lighter)] dark:text-[var(--color-darker)] bg-[var(--color-darker)] dark:bg-[var(--color-lighter)]">
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-sm">
        ...
        <div>
          ...
          <p>Phone: <a className="underline">(936)-404-3346</a></p>
          <p>
            Email: <a href="mailto:cbpcbphillips@gmail.com" className="underline">cbpcbphillips@gmail.com</a>
          </p>
          <div className="flex gap-4 mt-3">
            <a href="https://github.com/cbpcbphillips" target="_blank" rel="noopener noreferrer">
              <Github className="w-5 h-5 hover:opacity-70 transition" />
            </a>
            <a href="https://www.linkedin.com/in/cbpcbphillips/" target="_blank" rel="noopener noreferrer">
        ...
        <div>
          ...
          <p className="mt-2">© {year} Carson Phillips. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
